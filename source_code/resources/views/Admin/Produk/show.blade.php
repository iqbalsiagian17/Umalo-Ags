                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Harga Tayang</td>
                                <td>{{ $produk->harga_tayang ? 'Rp ' . number_format($produk->harga_tayang, 0, ',', '.') : '-' }}
                                </td>
                            </tr>
                            <tr>
                                <td>Harga Diskon</td>
                                <td>{{ $produk->harga_potongan ? 'Rp ' . number_format($produk->harga_potongan, 0, ',', '.') : '-' }}
                                </td>
                            </tr>
                            <tr>
