                            ...
                            <div class="product__details__text">
                                ...
                                <ul>
                                    ...
                                    <li><b>{{ __('messages.commodity') }}</b>
                                        <span>{{ $produk->komoditas ? $produk->komoditas->nama : 'N/A' }}</span>
                                    </li>
                                    <li><b>{{ __('messages.category') }}</b>
                                        <span>{{ $produk->kategori ? $produk->kategori->nama : 'N/A' }}</span>
                                    </li>
                                    <li><b>{{ __('messages.sub_category') }}</b>
                                        <span>{{ $produk->subKategori ? $produk->subKategori->nama : 'N/A' }}</span>
                                    </li>
