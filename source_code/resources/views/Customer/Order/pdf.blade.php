...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Bizpark Jababeka, Jl. Industri Sel. Blok QQ No.6, Pasirsari, Cikarang Sel., Kabupaten Bekasi, Jawa Barat
                17530</p>
        ...
        <div class="footer">
            ...
            <div style="margin-top: 40px;">
                ...
                <!-- Loop through each Materai image and convert to Base64 -->
                @foreach ($materai as $item)
                    @php
                        $path = public_path($item->image);
                        $base64 = base64_encode(file_get_contents($path));
                    @endphp
                    <img src="data:image/png;base64,{{ $base64 }}" alt="Materai Image" style="width: 150px; height: auto; margin-bottom: 10px;">
                @endforeach
                ...
                <div style="margin-top: 30px;">
                    <p><strong>PT. Arkamaya Guna Saharsa</strong></p>
                    <p>Jl. Matraman Raya No.148, Blok A2 No. 3 RT.1/RW.4, Kb. Manggis, Kec. Matraman, Kota Jakarta
                        Timur, Daerah Khusus Ibukota Jakarta 13150</p>
