...
<head>
    ...
    <style>
        ...
        .header-title h1 {
            font-size: 28px;
            margin: 0;
            color: #b8860b; /* Gold color similar to the image */
            font-weight: 700;
        }
    ...
    .icon-location svg {
        fill: #333; /* Dark color for the location icon */
    }

    .icon-envelope svg {
        fill: #FFD700; /* Gold color for the envelope icon */
    }
            ...
            <div class="company-details">
                <p>
                    <span class="icon icon-location">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M168 0C75.2 0 0 75.2 0 168s168 344 168 344s168-266.7 168-344S260.8 0 168 0zM168 256c-48.5 0-88-39.5-88-88s39.5-88 88-88s88 39.5 88 88S216.5 256 168 256z"/></svg>
                    </span>
                ...
                <p>
                    <span class="icon icon-envelope">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M502.3 190.8c3.5 2.7 5.7 7 5.7 11.6c0 4.2-2 8.2-5.4 10.8L256 416 8.5 213.2C4.9 210.7 2 206.7 2 202.4c0-4.6 2.2-8.9 5.7-11.6L256 32l246.3 158.8zM496 464H16c-8.8 0-16-7.2-16-16v-288l224 160c13.6 9.7 32 9.7 45.6 0L512 160v288C512 456.8 504.8 464 496 464z"/></svg>
                    </span>
                    info@labtek.id
                    |
                    <span class="icon icon-phone">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M493.4 24.6L368 9.3c-8.3-1.1-16.6 2.5-22.4 8.9l-104 112c-6.3 6.8-7.8 16.6-4.3 25.1l32 80c3.1 7.8 1.4 16.9-4.3 23l-56 56c-3.1 3.1-8.3 3.1-11.4 0L128 336c-6.3-6.3-16.4-7.9-24.3-4.3l-80 32c-8.4 3.5-18.2 1.9-25-4.3L8.9 144c-6.4-6.4-9.9-14.7-8.9-22.9l15.3-125.4c1.2-10.2 9.2-18.5 19.5-19.5l96-8.5c6.8-.7 13.5 2.1 18.1 7.7l96 112c4.5 5.2 6.5 12 5.7 18.9L144 96 288 240l-96 64z"/></svg>
                    </span>
                    (021) 85850913
                </p>
            </div>
